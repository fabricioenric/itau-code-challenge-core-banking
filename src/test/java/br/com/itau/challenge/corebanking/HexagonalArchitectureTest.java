...
class HexagonalArchitectureTest {
    ...
    private static final String DOMAIN = BASE_PACKAGE + ".corebanking.domain..";
    private static final String PORT = BASE_PACKAGE + ".corebanking.port..";
    private static final String APPLICATION = BASE_PACKAGE + ".corebanking.application..";
    private static final String ADAPTER = BASE_PACKAGE + ".corebanking.adapter..";
    ...
    void nenhumaCamadaDeveTerDependenciaCiclica() {
        ArchRule rule = com.tngtech.archunit.library.dependencies.SlicesRuleDefinition.slices()
                .matching(BASE_PACKAGE + ".corebanking.(*)..")
